...
# Словарь для "Ударений" (оставляем как есть, сокращаю для примера)
words = {
...
# Новый словарь для "Морфологических норм" (пример, дополните остальное)
morphology_words = {
    "борт": "бортА",
    "вексель": "векселЯ",
    "вензель": "вензелЯ",
    ...
    "копытце (р.п.)": "копЫтец",  # или "копЫтцев" — оба варианта допустимы, оставлю первый
    "одеяльце (р.п.)": "одеЯлец",
    "полотенце (р.п.)": "полотЕнец",
    "сердце (р.п.)": "сердЕц",
    "болотце (р.п.)": "болОтцев",
    "кружевце (р.п.)": "крУжевцев",  # или "крУжевец" — оставлю первый
    "оконце (р.п.)": "окОнцев",  # или "окОнец" — оставлю первый
    "вафля (р.п.)": "вАфель",
    "петля (р.п.)": "пЕтель",
    "потеря (р.п.)": "потЕрь",
    "туфля (р.п.)": "тУфель",
    ...
    "богиня (р.п.)": "богИнь",
    "погоня (р.п.)": "погОнь",
    "тихоня (р.п.)": "тихОнь",  # или "тихОней" — оставлю первый
    "яблоня (р.п.)": "Яблонь",
    "басня (р.п.)": "бАсен",
    "башня (р.п.)": "бАшен",
    "бойня (р.п.)": "бОен",
